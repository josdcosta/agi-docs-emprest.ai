...
Empréstimo Pessoal:
- Aplica [11.1.2. Idade Máxima](#1112-idade-máxima).
- Aplica [11.1.1. Valor do Empréstimo](#1121-valor-do-empréstimo).
- Aplica [11.1.2. Quantidade de Parcelas](#1122-quantidade-de-parcelas).
- Aplica [11.1.3. Score de Crédito](#1123-score-de-crédito).
